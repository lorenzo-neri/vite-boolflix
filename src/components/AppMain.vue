                    ...
                    <div v-if="store.results.length > 0">
                        ...
                        <div class="card">
                            <div id="card_poster">
                                ...
                                <img :src="result.poster_path ? (store.url_poster + store.size_poster + result.poster_path) : 'https://picsum.photos/405/607'"
                            ...
                            <div id="card_info" class="text-white">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        <span
                                            v-if="result.original_title != result.title || result.original_name != result.name">
